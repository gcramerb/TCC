...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 2:
        ...
        #data_input_file = '~/home/cramer/Área de Trabalho/Lab Sense/datasets/MHEALTH.npz'
    ...
    X_2k,y,folds = mc.load_data(data_input_file, missing_factor,sensor_factor,missing_type)
    X_2k,y,folds = mc.load_missing_data(data_input_file, missing_factor, sensor_factor, missing_type)
